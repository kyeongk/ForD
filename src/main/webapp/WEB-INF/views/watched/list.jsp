...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 wListHeaderDiv">
        <h1 class="page-header listHeader">시청완료
        </h1>
        <a class='wListOrder'>정렬하기 <i class="fas fa-chevron-down"></i></a>
		<ul class="dropdown-menu wListOrderUl">
			<li><a href="/watched/list?order=title">가나다순</a></li>
			<li><a href="/watched/list?order=date">최근방영순</a></li>
			<li><a href="/watched/list">랜덤정렬</a></li>
		</ul>
				...
				<c:forEach items="${list }" var="board">
					...
					<li class=' list-inline-item'>
						<div class='col-lg-12 col-md-12 col-sm-12 watchedList'>
							...
							<div class='scoreDiv'>내 평점 ★ <c:out value="${board.avgScore }"/></div>
						</div>
					</li>
					</c:if>
					</sec:authorize>
