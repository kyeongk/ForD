...
import com.forD.service.EpiReviewService;
...
public class EpiReviewController {
	...
	@GetMapping(value="/pages/{all_drama_id}/{page}/{userid}", produces= {MediaType.APPLICATION_XML_VALUE,MediaType.APPLICATION_JSON_VALUE})
	...
	//회차별 리뷰 조회
	@GetMapping(value="/{id}/{userid}", produces= {MediaType.APPLICATION_XML_VALUE,MediaType.APPLICATION_JSON_VALUE})
	@PreAuthorize("principal.username==#userid")
